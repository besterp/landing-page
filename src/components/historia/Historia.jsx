  ...
  return (
    <div className="historia-container">
      ...
      <div className="historia-content">
        ...
        <p className="mt-2 text-xl text-gray-800 font-montserrat">
          Vamos a cumplir 18 años de vida empresarial y a lo largo de dicho periodo, hemos logrado una rápida evolución, para responder a un mundo cambiante y complejo. 
        </p>
        <p className="mt-2 text-xl text-gray-800 font-montserrat">
